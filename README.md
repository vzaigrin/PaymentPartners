...
При загрузки файлов со справочниками в систему срабатывает функция **LoadDicts**. Файлы со справочниками должны называться так же как называются таблицы справочников, и должны содержать весь справочник.
...
- DM_REPORT - отчёты расчётных периодов
