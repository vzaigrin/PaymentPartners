...
При загрузки файлов со справочниками в систему срабатывает скрипт **load_dicts**. Файлы со справочниками должны называться так же как называются таблицы справочников, и должны содержать весь справочник.

Для обработки файлов с реестрами по расписанию (16-го числа каждого месяца в 0:0) запускается скрипт **load_data**.
